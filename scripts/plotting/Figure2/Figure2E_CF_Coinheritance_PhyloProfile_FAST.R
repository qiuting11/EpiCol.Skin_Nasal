...
pdf(file.path("outputs/Figure2", "Figure2E_CF_Coinheritance_PhyloProfile_FAST.pdf"), width = 20, height = 8.7)
...
png(file.path("outputs/Figure2", "Figure2E_CF_Coinheritance_PhyloProfile_FAST.png"),
  width = 20, height = 8.7, units = "in", res = 300
)
