library(tidyverse)
# Read CSV file  
result_df <- read_csv('data/external/mi_zscore.csv')  
...
print(mi_z_fixed)
ggsave(file.path("outputs/Figure2", "FigureS2B_MI_Zscore_Distribution_FullQuantiles.png"), mi_z_fixed, dpi = 300, width = 10, height = 6)
...
ggsave(file.path("outputs/Figure2", "FigureS2B_MI_Zscore_Distribution_Alt.png"), mi_z_0998_only, dpi = 300, width = 8, height = 6)
ggsave(file.path("outputs/Figure2", "FigureS2B_MI_Zscore_Distribution_Alt.pdf"), mi_z_0998_only, dpi = 300, width = 8, height = 6)
...
# Save plots
ggsave(file.path("outputs/Figure2", "Figure2B_MI_Zscore_Distribution.png"), g_top, dpi = 300, width = 8, height = 6)
ggsave(file.path("outputs/Figure2", "Figure2B_MI_Zscore_Distribution.pdf"), g_top, dpi = 300, width = 8, height = 6)
