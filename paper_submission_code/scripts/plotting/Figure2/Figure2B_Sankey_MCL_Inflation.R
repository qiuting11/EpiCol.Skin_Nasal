...
# Read data
mcl_1 <- read.csv('E:/data/gephe_output_11/analysis/output_test_1/mcl_1.4.csv')
mcl_2 <- read.csv('E:/data/gephe_output_11/analysis/output_test_1/mcl_2.0.csv')
mcl_3 <- read.csv('E:/data/gephe_output_11/analysis/output_test_1/mcl_3.0.csv')
...
ggsave("Figure2C_Sankey_MCL_Inflation.png", width=10, height=10, dpi=300)
ggsave("Figure2C_Sankey_MCL_Inflation.pdf", width=10, height=10, dpi=300)
