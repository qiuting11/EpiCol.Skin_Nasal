...
paths <- list(
  modules = "E:/data/gephe_output_11/analysis/output_test_1/top0.2_I3.0_modules.txt",
  eggnog = "E:/data/gephe_output_11/analysis/input/eggnog_output_with_pog_multi_level.tsv",
  metadata = "E:/data/gephe_output_11/analysis/input/metadata_for_analysis.tsv",
  pog_copy = "E:/data/gephe_output_11/refined_output/refined_output_top0.2/test/pog_copy_number_profiles.tsv",
  out_dir = "E:/data/R/gephe_R/results/figures/Figure3_Final"
)
...
figure3a_module_summary <- figure3a_cf_table %>%
  ...
  summarise(
    n_cf = n_distinct(CF),
    representative_CFs = paste(CF, collapse = "; "),
...
priority_species_table <- tibble::tribble(
  ...
  "Staphylococcus epidermidis", "Skin Staphylococcus", "common human skin Staphylococcus; priority representative",
  "Staphylococcus aureus", "Skin/Nasal Staphylococcus", "clinically important Staphylococcus and nasal carriage species",
  "Staphylococcus hominis", "Skin Staphylococcus", "common human skin Staphylococcus; expanded skin-side representation",
  "Staphylococcus capitis", "Skin Staphylococcus", "common human skin Staphylococcus; expanded skin-side representation",
  ...
  "Cutibacterium acnes", "Skin Cutibacterium", "canonical human skin Cutibacterium",
  "Cutibacterium granulosum", "Skin Cutibacterium", "human skin Cutibacterium representative",
...
rules_md <- c(
  ...
  "## Chinese",
  "",
  "图3B中的属定义为本研究皮肤和鼻腔MAG集合中反复检出的代表性属。该筛选是基于本研究数据的展示规则，不使用此前的人工 genus-prefix 白名单。",
  "",
  "1. 仅纳入具有属级注释且 Habitat 规范为 Skin 或 Nasal 的 MAG。",
  "2. 分别按照 Skin 来源基因组数和 Nasal 来源基因组数对属进行排序。",
  paste0("3. 取 Skin 排名前 ", top_n_per_habitat, " 的属与 Nasal 排名前 ", top_n_per_habitat, " 的属的并集。"),
  paste0("4. 通过排序进入主图的属需满足总基因组数不少于 ", min_genomes_main, "。"),
  paste0("5. 手动保留属会被明确标记，目前为：", paste(manual_keep_genera, collapse = "; "), "。"),
  "",
  "因此，图注中建议表述为“本研究皮肤和鼻腔MAG集合中反复检出的代表性属”，避免表述为“显著生态位相关属”或“生态位特异属”。",
  "",
